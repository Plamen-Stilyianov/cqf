...
public final class Function {
    ...
    static double vals[] = {76.18009172947146, -86.50532032941677, 24.01409824083091, -1.231739572450155, 0.1208650973866179e-2,
    ...
    {
        return
                (Math.PI) / (gamma(1 - x) * (Math.sin(Math.PI * x)));
    }
    ...
    public static double binom(int n, int k) {
        // max 100 n 17 k     Binomial coefficient    no of  ways that k things can be selected from n items//
    ...
    public static double betainv(double x, double y) {// returns same as 1/beta  //
