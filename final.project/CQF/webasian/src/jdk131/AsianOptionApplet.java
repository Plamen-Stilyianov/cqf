 ...
 */
public class AsianOptionApplet extends JApplet{
   ...
   */
        ...
        runButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                double rateIn = rate.doubleValue()/100;
                double divIn = div.doubleValue()/100;
                double volIn = vol.doubleValue()/100;

                monteModel = new ArithMonteCarloGeoContVar(spPrice.doubleValue(), stPrice.doubleValue(),rateIn , divIn, volIn, yrs.doubleValue());
                geoModel = new GeometricModels(spPrice.doubleValue(), stPrice.doubleValue(), rateIn, divIn, volIn, yrs.doubleValue());
                bsModel = new GenBlackScholesModels(spPrice.doubleValue(), stPrice.doubleValue(), rateIn, divIn, volIn, yrs.doubleValue());
                artModel = new ArithmeticModels(spPrice.doubleValue(), stPrice.doubleValue(), rateIn, divIn, volIn, yrs.doubleValue());
